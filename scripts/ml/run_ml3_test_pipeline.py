...
Output directories:
  docs/benchmarking/ml/results/test/sim_<name>/   — varforge outputs
  docs/benchmarking/ml/results/test/kam_<name>/   — kam outputs
  docs/benchmarking/ml/samples/test/<name>/        — sample dirs for training data builder
...
CONFIGS = sorted((REPO / "docs/benchmarking/ml/configs/test").glob("*.yaml"))
SIM_DIR = REPO / "docs/benchmarking/ml/results/test"
KAM_DIR = REPO / "docs/benchmarking/ml/results/test"
SAMPLES = REPO / "docs/benchmarking/ml/samples/test"
...
def build_sample_one(name: str) -> tuple[str, str]:
    ...
    # Copy params.json.
    params_src = REPO / "docs/benchmarking/ml/configs/test" / f"{name}_params.json"
