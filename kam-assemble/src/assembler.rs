...
mod tests {
    ...
    // Regression test for BUG-003: call_ssc_bases always used template_r1,
    // so duplex consensus compared R1 against R1 instead of R1 against R2.
    // With deliberately distinct R1 and R2 templates, the wrong selection
    // causes a strand disagreement that produces N-masked or absent output.
    //
    // Setup:
    ...
    //          Both strands disagree → duplex consensus is N-masked or absent.
    ...
    fn duplex_consensus_uses_r1_for_fwd_and_r2_for_rev() {
        ...
        // Forward read: R1_UMI = umi_a = ACGTA → strand = Forward.
        // template_r1 = "AAAA..." (sense strand template).
        // template_r2 = "CCCC..." (antisense template).
        let fwd_pair = crate::parser::ParsedReadPair {
            umi_r1: *b"ACGTA",
            umi_r2: *b"TGCAT",
            skip_r1: *b"TG",
        ...
        // Reverse read: R1_UMI = umi_b = TGCAT → strand = Reverse.
        // template_r1 = "CCCC..." (antisense strand on this read's R1).
        // template_r2 = "AAAA..." (sense strand on this read's R2).
        let rev_pair = crate::parser::ParsedReadPair {
            umi_r1: *b"TGCAT",
            umi_r2: *b"ACGTA",
            skip_r1: *b"TG",
        ...
        // Correct selection: fwd uses R1 = "AAAA...", rev uses R2 = "AAAA...".
        // Both strands agree, so every base must be 'A'.
        assert!(
