...
for vaf in VAF_LEVELS:
    ...
    for rep_idx, rep in enumerate(["a", "b"]):
        ...
        write_config(sv_cfg,
            ...
            vcf_rel=f"docs/benchmarking/02-sv-core/data/truth_svs_vaf{t}_{rep}.vcf",
            out_dir=f"docs/benchmarking/02-sv-core/results/sim_sv_vaf{t}_{rep}",
        ...
        write_config(ins_cfg,
            ...
            vaf=vaf, purity=purity,
            vcf_rel=f"docs/benchmarking/02-sv-core/data/truth_ins_vaf{t}_{rep}.vcf",
            out_dir=f"docs/benchmarking/02-sv-core/results/sim_ins_vaf{t}_{rep}",
        ...
        write_config(invdel_cfg,
            ...
            vaf=vaf, purity=purity,
            vcf_rel=f"docs/benchmarking/02-sv-core/data/truth_invdel_vaf{t}_{rep}.vcf",
            out_dir=f"docs/benchmarking/02-sv-core/results/sim_invdel_vaf{t}_{rep}",
