...
FUSION_REF_PATH = "docs/benchmarking/03-sv-extended/data/fusion_ref.fa"
...
# the target fusion VAF. See docs/benchmarking/03-sv-extended/README.md for mixing steps.
reference: {ref_path}
...
def main() -> None:
    ...
    for vaf in VAF_LEVELS:
        ...
        for rep_idx, rep in enumerate(["a", "b"]):
            ...
            out_dir = f"docs/benchmarking/03-sv-extended/results/sim_fusion_vaf{t}_{rep}"
    ...
    print()
    print("See docs/benchmarking/03-sv-extended/README.md for the mixing step.")
