...
Inputs:
  ...
  docs/benchmarking/runtime/alignment_timings.csv

Output:
  docs/benchmarking/runtime/figures/runtime_comparison.pdf
...
Run from the repo root:
    python3 docs/benchmarking/runtime/scripts/plot_runtime.py
"""
...
KAM_CSV   = REPO / "docs/benchmarking/runtime/kam_timings.csv"
ALIGN_CSV = REPO / "docs/benchmarking/runtime/alignment_timings.csv"
OUT_DIR   = REPO / "docs/benchmarking/runtime/figures"
