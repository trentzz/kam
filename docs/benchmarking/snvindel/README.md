...
│   ├── configs/                 — varforge configs for each condition
│   └── ...
├── analysis/          — results writeups
│   └── results_v10_2m_reads_k31.md
...
python3 docs/benchmarking/snvindel/scripts/run_titration_batch.py \
    --fastq-dir "$FASTQ_DIR" \
    --output-dir docs/benchmarking/snvindel/per_sample \
    --depths 2000000
```
