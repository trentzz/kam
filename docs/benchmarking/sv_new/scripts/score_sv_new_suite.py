...
Inputs:
  docs/benchmarking/sv_new/results/sim_{type}_vaf{tag}_{rep}/*.truth.vcf
  docs/benchmarking/sv_new/results/kam_{type}_vaf{tag}_{rep}/calls_{mode}.vcf
  docs/benchmarking/sv_new/data/truth_fusion_vaf{tag}_{rep}.vcf  (for fusion)

Outputs:
  docs/benchmarking/sv_new/summary/sv_new_per_dataset.tsv
  docs/benchmarking/sv_new/summary/sv_new_summary.tsv

Run from the repo root:
    python3 docs/benchmarking/sv_new/scripts/score_sv_new_suite.py
"""
