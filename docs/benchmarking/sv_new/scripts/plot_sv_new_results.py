...
Outputs (to docs/benchmarking/sv_new/figures/):
...
Run from the repo root:
    python3 docs/benchmarking/sv_new/scripts/plot_sv_new_results.py
"""
...
SV_NEW_PER_DS = REPO / "docs/benchmarking/sv_new/summary/sv_new_per_dataset.tsv"
SV_OLD_PER_DS = REPO / "docs/benchmarking/sv/summary/sv_per_dataset.tsv"
OUT_DIR = REPO / "docs/benchmarking/sv_new/figures"
