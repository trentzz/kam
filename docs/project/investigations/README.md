...
|---|---|---|---|---|---|
| `reach_100_indels_2026-04-19.md` | 2026-04-19 | SNV/indel, ti-rescue | Can we push from 72/170 to 100/170 INDEL sensitivity? | ~98/170 truth indels absent from ctDNA sample; ceiling confirmed at 72/170 with k=31 regardless of window size or threshold | 150/200bp windows recover +1 indel; data ceiling confirmed; raw-read analysis in progress |
