...
|---|---|---|---|---|---|
| `alt_as_km_target_2026-04-19.md` | 2026-04-19 | SNV/indel, kmtools | Claim that ALT sequences as km targets recover 100+ indels on 15ng 2% VAF | 96/170 truth indels have zero ALT-allele k-mers; ALT-as-target gives 74 vs 70 baseline; +4 are mislabelled insertions | Claim not reproducible; max 74/170; standard REF-target approach recovers same set if reference.tsv TYPE is corrected |
| `reach_100_indels_2026-04-19.md` | 2026-04-19 | SNV/indel, ti-rescue | Can we push from 72/170 to 100/170 INDEL sensitivity? | ~96/170 truth indels absent from ctDNA sample; true junction k-mer ceiling is 79/170 at 5M reads | Best achieved 74/170 (43.5%) at 5M reads, 150bp targets; 74/79 = 93.7% of ceiling; all parameter axes exhausted |
| `indel_sensitivity_ti_mode_2026-04-19.md` | 2026-04-19 | SNV/indel, ti-rescue | INDEL sensitivity ~40% at 2% VAF; gap vs kmtools ~60% | Stale alt-seq file + 99/170 truth indels genuinely absent from ctDNA sample | Fixed alt-seq generation; confirmed data ceiling; full 24-sample batch at FP=0 |
| `altseq_indel_sensitivity.md` | 2026-04-19 | SNV/indel, indexing, pathfind, ti-rescue | 37% indel sensitivity at 15ng 2% VAF; alt-as-ref produced no improvement for indels | Alt-seq had zero k-mers (no --flank); after fixing, bottleneck is coverage not algorithm (63/170 targets have zero molecules at 1M reads); build_alt_seq offset off-by-one masked rescue probe results | Normalised truth VCF (+7 TP), fixed offset bug, identified coverage as dominant cause; ceiling at 41.2% without more reads |
