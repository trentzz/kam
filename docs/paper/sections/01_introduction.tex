...
On the Twist cfDNA Pan-Cancer Reference Standard v2 titration series, kam detects 52--61\% of truth variants at 2\% VAF with precision of 0.57--0.77 using 2 million read pairs per sample, running in under 30 seconds per sample on a single core.
