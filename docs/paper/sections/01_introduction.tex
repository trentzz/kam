...
On the Twist cfDNA Pan-Cancer Reference Standard v2 titration series, kam detects 52--61\% of truth variants at 2\% VAF with precision 0.58--0.78 (with a germline VAF filter applied) using 2 million read pairs per sample, running in 19--35 seconds per sample on a single core.
