...
rates are 4.6--15.5\% of molecules. With a germline VAF filter applied
($\text{VAF} \le 0.35$), kam detects 52--61\% of truth variants at 2\% VAF
with precision 0.58--0.78, running end-to-end in 19--35 seconds per sample
on a single core. SNV sensitivity reaches 69--80\% at 2\% VAF; indel
sensitivity is 32--39\%. Sensitivity extends to the 0.25--0.5\% VAF range
at 15--30\,ng input, reaching 7--48\% across those concentrations.
