...
at 2\% VAF with precision 0.64--0.80 using 2M read pairs per sample. In
...
rates are 4.6--15.5\% of molecules. With recommended filters
...
end-to-end in 19--35 seconds per sample on a single core. SNV sensitivity
