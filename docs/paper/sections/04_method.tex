...
Chemistry presets cover Twist duplex (default), and the \texttt{[chemistry]} section accepts arbitrary UMI and skip lengths for other chemistries. The pipeline is not hard-coded to any specific adapter design.
